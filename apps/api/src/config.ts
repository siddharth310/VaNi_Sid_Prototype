...
const envSchema = z.object({
  ...
  ELEVENLABS_API_KEY: z.string().optional().default('sk_6ad37f2dc38b9f7bfe2d3c15811408a28812fef7b26d7e40'),
  ELEVENLABS_DEFAULT_AGENT_ID: z.string().optional().default(''),
  ELEVENLABS_DEFAULT_VOICE_ID: z.string().optional().default('hpp4J3VqNfWAUOO0d1Us'),
